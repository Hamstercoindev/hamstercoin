...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hamstercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"hamstercoin.com", "31.131.23.80"},
	{"31.131.23.80", "31.131.23.80"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hamstercoin is probably already running."), addrBind.ToString().c_str());
        else
